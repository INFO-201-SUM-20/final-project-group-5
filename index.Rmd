...
The coronavirus has reached **`r comma(info$total_cases, digits = 0)` cases** and **`r comma(info$total_deaths, digits = 0)` deaths**  since it's inception in the United States. The worst day of COVID-19 had **`r info$most_deaths_in_a_day` deaths** in a single day. The most cases in a single day was **`r comma(info$most_cases_in_a_day, digits = 0)`** cases.

Since the first COVID-19 case in the U.S, the DOW JONES index has reached a low of **`r comma(info$lowest_dow_jones, digits = 2)`** and a high of **`r comma(info$highest_dow_jones, digits = 2)`**. The S&P 500 has reached a high of **`r comma(info$highest_spy, digits = 2)`** and a low of **`r comma(info$lowest_spy, digits = 2)`**.
