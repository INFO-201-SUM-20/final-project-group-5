...
The datasets we analyzed were taken from John Hopkins and Yahoo Finance. After combining these datasets, our data had `r info$num_rows` observations  and `r info$num_columns` columns.
